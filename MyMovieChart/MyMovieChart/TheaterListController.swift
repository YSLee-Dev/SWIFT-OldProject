...
class TheaterListController:UITableViewController{
    ...
    func callTheaterAPI(){
        ...
        do{
            ...
            // 4. 문자열로 받은 데이터를 UTF-8로 인코딩처리한 Data로 반환한다.
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        let mvc = self.storyboard?.instantiateViewController(identifier: "TheaterViewController") as? TheaterViewController
        
        mvc?.param = list[indexPath.row]
